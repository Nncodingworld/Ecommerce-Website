        ...
        <div className="singleProduct-infoSection">
          ...
          <p className="singleProduct-description">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
             Accusantium quam aliquam accusamus sunt obcaecati dolorum 
            a corrupti adipisci autem reprehenderit!
          </p>
          <div className="singleProduct-options">
            <div className="colors-section">
                ...
                <div className="colors">
                    {colors.map((color)=>(
                        <div 
                        key={color} className="color-circle" style={{ backgroundColor: color, outline: selectedColor === color ? `3px solid ${color}` : "" }}
